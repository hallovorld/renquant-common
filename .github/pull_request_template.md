...
- [ ] **Contract changes are versioned.** A new artifact key, schema field or fingerprint classification states which schema version introduces it and asserts a known historical artifact still hashes to its recorded value. An unclassified key must keep raising (issue #38).
